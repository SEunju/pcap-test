...
int main(int argc, char* argv[]) {
    ...
    while (true) {
        ...
        // IPv4
        struct libnet_ipv4_hdr *ip_hdr = packet + sizeof(struct libnet_ethernet_hdr);   // packet + 14;
        ...
        // TCP
        struct libnet_tcp_hdr *tcp_hdr = (u_char*)ip_hdr + sizeof(struct libnet_ipv4_hdr);
        ...
        if (header->caplen > 54) {
            u_char* packet2 = (u_char*)tcp_hdr + sizeof(struct libnet_tcp_hdr);
            printf("Payload(Data) : ");
            int cnt = header->caplen - 54;
